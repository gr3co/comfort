//
//  CMCampaignVisibilityTableViewCell.m
//  ComfortMe
//
...
@interface CMCampaignVisibilityTableViewCell() {
    UILabel *campaignLabel;
}

@end

@implementation CMCampaignVisibilityTableViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.backgroundColor = [CMColors mainColor];
        [self setupLabel];
        [self setupSwitch];
    }
    return self;
